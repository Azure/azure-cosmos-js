...
export class FeedOptions {
   ...
   */
  public disableRUPerMinuteUsage?: boolean;
  /**
   ...
   */
  public maxDegreeOfParallelism?: number;
  ...
  public populateQueryMetrics?: boolean;
}
