...
export class HashPartitionResolver {
    private partitionKeyExtractor: string | Function; // TODO: Function could be more specific
     ...
     **/
    constructor(partitionKeyExtractor: string | Function, collectionLinks: any[], options: any) { // TODO: options
         ...
         * @returns {object} 
         **/
        public getPartitionKey(document: any) {
         ...
         **/
        public resolveForRead(partitionKey: string) {
        ...
        /** @ignore */
        private static _throwIfInvalidPartitionKeyExtractor(partitionKeyExtractor: string | Function) {
        ...
        /** @ignore */
        private static _throwIfInvalidPartitionKey(partitionKey: string) {
