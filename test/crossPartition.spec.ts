...
import { ErrorResponse } from "../src/request";
...
describe("Cross Partition", function () {
    ...
    describe("Validate Query", function () {
        ...
        // const validateExecuteNextWithGivenContinuationToken =
        //     async function (collectionLink: string, query: , origOptions, listOfResultPages, listOfHeaders) {
        ...
        //             const fromTokenToLastPageValidator = function (
        // queryIterator, token, expectedResultsFromToken, expectedHeadersFromToken) {
        ...
        //                         return fromTokenToLastPageValidator(
        //                              queryIterator, token, expectedResultsFromToken, expectedHeadersFromToken);
        //                     } else {
        ...
        //             }
        //             return fromTokenToLastPageValidator(
        // queryIterator, continuationToken, listOfResultPages, listOfHeaders);
        //         }
